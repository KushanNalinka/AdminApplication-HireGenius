...
//         // 🔑 Normalise every array-like field so React can safely .map()
//         const normalise = (field) =>
//           Array.isArray(field)
//             ? field
//             : typeof field === "string" && field.trim().startsWith("[")
//             ? JSON.parse(field)
//             : [];

//         setCandidate({
//           ...data,
//           experience: normalise(data.experience),
//           education: normalise(data.education)
...
//         description="Detailed Candidate Information"
//       />
//       <PageBreadcrumb
//         pageTitle={`${candidate.firstName} ${candidate.lastName}`}
//       />
...
//         </h1>
//         <p className="text-center text-[#DBD8E3] mb-6">
//           {candidate.confirmEmail}
//         </p>

//         {/* ——— Job Details ——— */}
//         <h2 className="text-xl font-semibold text-[#DBD8E3] mb-3">
//           Job Position
//         </h2>
//         <p className="text-[#DBD8E3]">
//           {candidate.jobPosition} – {candidate.jobTitle}
//         </p>
...
//             <span className="text-green-400">{candidate.university}</span>
//           </p>
//           <p className="text-[#DBD8E3]">
//             <strong>Education Level : </strong>
//             <span className="text-green-400">{candidate.education_level}</span>
//           </p>
//         </div>
...
//           <h2 className="text-2xl font-bold text-[#DBD8E3] mb-4">
//             Candidate Insights for Job
//           </h2>
//           <p className="text-[#DBD8E3]">
//             <strong>Preferred Salary Range : </strong>
//             <span className="text-green-400">{candidate.salaryRange}</span>
//           </p>
//           <p className="text-[#DBD8E3]">
//             <strong>Vacancy Source : </strong>
//             <span className="text-green-400">{candidate.vacancySource}</span>
//           </p>
//           <p className="text-[#DBD8E3]">
//             <strong>No. of Years of Experience : </strong>
//             <span className="text-green-400">
//               {candidate.noofyearsofexperience}
//             </span>
//           </p>
//           <p className="text-[#DBD8E3]">
//             <strong>Policy State : </strong>
//             <span className="text-green-400">{candidate.privacyPolicy}</span>
//           </p>
//           <p className="text-[#DBD8E3]">
//             <strong>Message To Hiring Manager : </strong>
//             <span className="text-green-400">{candidate.message}</span>
//           </p>
//           <p className="text-[#DBD8E3]">
//             <strong>Employer Choice : </strong>
//             <span className="text-green-400">{candidate.employerChoice}</span>
//           </p>
//           <p className="text-[#DBD8E3]">
//             <strong>Employer Expectations : </strong>
//             <span className="text-green-400">
//               {candidate.employerExpectations}
//             </span>
//           </p>
//         </div>
...
//           </h2>
//           <p className="text-[#DBD8E3]">
//             <strong>Predicted Matching Percentage : </strong>
//             <span className="text-green-400">
//               {candidate.predicted_matching_percentage}%
//             </span>
//           </p>
//           <p className="text-[#DBD8E3]">
//             <strong>Work Experience Matching : </strong>
//             <span className="text-green-400">
//               {candidate.workExperienceMatchingSimilarity}%
//             </span>
//           </p>
//           <p className="text-[#DBD8E3]">
//             <strong>Achievements Similarity : </strong>
//             <span className="text-green-400">
//               {candidate.achievements_similarity}%
//             </span>
//           </p>
//           <p className="text-[#DBD8E3]">
//             <strong>Courses & Certifications Similarity : </strong>
//             <span className="text-green-400">
//               {candidate.coursesAndCertificationMatchingSimilarity}%
//             </span>
//           </p>
//           <p className="text-[#DBD8E3]">
//             <strong>Projects Matching Similarity : </strong>
//             <span className="text-green-400">
...
//             <div
//               key={idx}
//               className="mb-4 p-4 bg-[#352F44] rounded-lg shadow-lg"
//             >
//               <p>
...
//               </p>
//               <p>
//                 <strong>From:</strong> {exp.from} – <strong>To:</strong>{" "}
//                 {exp.to}
//               </p>
//               <p>
...
//             <span className="text-green-400">
//               {candidate.extractednoofprogramminglanguages}
//             </span>
//           </p>
//           <p className="text-[#DBD8E3]">
//             <strong>Frameworks : </strong>
//             <span className="text-green-400">
//               {candidate.extractednoofprogrammingframeworks}
//             </span>
//           </p>
//           <p className="text-[#DBD8E3]">
//             <strong>Cloud Technologies : </strong>
//             <span className="text-green-400">
//               {candidate.extractednoofcloudtechnologies}
//             </span>
//           </p>
//           <p className="text-[#DBD8E3]">
//             <strong>Databases : </strong>
//             <span className="text-green-400">
//               {candidate.extractednoofdatabasetechnologies}
//             </span>
//           </p>
//           <p className="text-[#DBD8E3]">
//             <strong>DevOps Tools : </strong>
//             <span className="text-green-400">
//               {candidate.extractednoofdevopstools}
//             </span>
//           </p>
//           <p className="text-[#DBD8E3]">
//             <strong>Software Development Methodologies : </strong>
//             <span className="text-green-400">
//               {candidate.extractednoofsoftwaredevelopmentmethodologies}
//             </span>
//           </p>
//           <p className="text-[#DBD8E3]">
//             <strong>Version Controlling : </strong>
//             <span className="text-green-400">
//               {candidate.extractednoofversioncontroltechnologies}
//             </span>
//           </p>
//           <p className="text-[#DBD8E3]">
//             <strong>Web Development Technologies : </strong>
//             <span className="text-green-400">
//               {candidate.extractednoofwebtechnologies}
//             </span>
//           </p>
//           <p className="text-[#DBD8E3]">
//             <strong>Total Number of Tools & Technologies : </strong>
//             <span className="text-green-400">
...
//           Project Experience
//         </h2>
//         <p>{candidate.project_experiences}</p>
//         {/* {candidate.project_experiences.length ? (
//           candidate.project_experiences.map((proj, idx) => (
//             <div
//               key={idx}
//               className="mb-4 p-4 bg-[#352F44] rounded-lg shadow-lg"
//             >
...
//             >
//               <p>
//                 <strong>Project / Work Title:</strong> {work}
//               </p>
//             </div>
//           ))
//         ) : (
...
//           Courses & Certifications
//         </h2>
//         <p>{candidate.courses_certifications_achievements}</p>
//         {/* {candidate.courses_certifications_achievements.length ? (
//           candidate.courses_certifications_achievements.map((cert, idx) => (
//             <div
//               key={idx}
//               className="mb-4 p-4 bg-[#352F44] rounded-lg shadow-lg"
//             >
//               <p>
//                 <strong>Certification:</strong> {cert.title}
//               </p>
//               <p>
...
//             >
//               <p>
//                 <strong>{cert.type}:</strong> {cert.content}
//               </p>
//             </div>
//           ))
//         ) : (
