  ...
  <>
    ...
    <div className="p-8 bg-gradient-to-br from-[#1a1625] via-[#2A2438] to-[#1f1b2e] text-white min-h-screen relative overflow-hidden">
      ...
      <div className="relative z-10 mb-8 animate-fadeInDown">
        <button
          className="group relative bg-gradient-to-r from-[#DBD8E3] to-[#f0eef5] text-black px-6 py-3 rounded-xl font-medium shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 ease-out hover:from-[#5C5470] hover:to-[#4a4560] hover:text-white border border-white/20 backdrop-blur-sm"
          onClick={() => navigate(-1)}
        >
      ...
      <div className="text-center mb-12 animate-fadeInUp">
        <div className="inline-flex items-center gap-3 mb-4">
          ...
          <h1 className="text-5xl font-bold bg-gradient-to-r from-[#DBD8E3] via-[#f0eef5] to-[#e8e5f0] bg-clip-text text-transparent drop-shadow-lg">
            Candidate Charts
          </h1>
              ...
              >
                ...
                <div className="mb-6">
                  <div className="inline-flex items-center gap-3 mb-3">
                    ...
                    <div className="text-2xl group-hover:animate-bounce delay-100">📊</div>
                  </div>
