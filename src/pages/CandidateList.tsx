      ...
      try {
        ...
        const sortedCandidates = response.data.sort((a, b) => {
          return (
            ...
            b.extract_workExperienceMatchingSimilarity -
              a.extract_workExperienceMatchingSimilarity ||
            b.extract_coursesAndCertificationMatchingSimilarity -
              a.extract_coursesAndCertificationMatchingSimilarity ||
